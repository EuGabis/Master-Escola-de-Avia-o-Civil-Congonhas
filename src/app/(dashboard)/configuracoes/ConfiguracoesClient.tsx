  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-50 dark:bg-slate-950">
      ...
      <header className="border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        <div className="px-6 lg:px-8 py-5">
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Gerencie integracoes e agentes
          </p>
        </div>
      </header>
      ...
      <div className="px-6 lg:px-8 pt-6">
        <nav className="flex flex-wrap gap-1.5 p-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl">
          {TABS.map((t) => {
            const Icon = t.icon;
            ...
            return (
              <button
                ...
                className={cn(
                  "flex items-center gap-2 px-3.5 py-2 text-sm font-medium rounded-lg transition",
                  active
                    ? "bg-master-orange text-white shadow-sm"
